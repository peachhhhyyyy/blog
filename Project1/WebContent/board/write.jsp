...
<body>
	<form method="post" action="board.do?m=insert&name=${loginPassUser.name}&email=${loginPassUser.email}" enctype="multipart/form-data">
		<div class="input input__text">
			<input type="text" name="subject" placeholder="제목" class="input" required />
		</div>
		<div class="input input__textarea">
		    <textarea rows="4" name="content" placeholder="내용" class="input" required></textarea>
		</div>
